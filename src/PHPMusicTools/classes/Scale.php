...
class Scale extends PMTObject
{
	...
	public static $scaleNames = array(
		...
		395 => array('Balinese'),
		397 => array("Aeolian Pentatonic","Hira-joshi","Kata-kumoi","Yona Nuki Minor: Japan","Tizita Minor (Half tizita): Ethiopia"),
		397 => array('Hirajoshi'),
		403 => array("Raga Reva, Revagupti","Ramkali","Vibhas (Bhairava)"),
		405 => array("Raga Bhupeshwari","Janasammodini"),
		419 => array("Hon-kumoi-joshi","Sakura","Akebono II: Japan","Olympos Enharmonic","Raga Salanganata","Saveri","Gunakri (Gunakali)","Latantapriya","Ambassel: Ethiopia",'japanese (a)'),
		421 => array("Han-kumoi: Japan, Raga Shobhavari, Sutradhari",'japenese (b)'),
		...
		597 => array("Kung: China"),
		619 => array("Double-Phrygian Hexatonic"),
		621 => array("Pyramid Hexatonic"),
		637 => array("Debussy's Heptatonic"),
		653 => array("Dorian Pentatonic","Raga Sivaranjini (Shivranjani)","Akebono I: Japan",'Kumoi'),
		659 => array("Raga Rasika Ranjani","Vibhas (Marva)","Scriabin"),
		661 => array("Major Pentatonic","Pentatonic Major","Ryosen","Yona Nuki Major: Japan","Man Jue","Gong: China","Raga Bhopali (Bhup)","Mohanam","Deskar","Bilahari","Kokila","Jait Kalyan","Peruvian Pentatonic 1","Ghana Pentatonic 2","Tizita Major: Ethiopia"),
		665 => array("Raga Mohanangi"),
		675 => array("Altered Pentatonic","Raga Manaranjani II"),
		677 => array("Scottish Pentatonic","Blues Major","Ritusen","Ritsu (Gagaku): Japan","Zhi","Zheng: China","Ujo","P'yongjo: Korea","Bac: Vietnam","Lai Soutsanaen","Lai Po Sai","Lai Soi: Laos","Raga Devakriya, Durga, Suddha Saveri, Arabhi, Major complement"),
		681 => array("Minor added sixth Pentatonic","Kyemyonjo: Korea"),
		...
		819 => array("Messiaen truncated mode 3","Prometheus (Liszt)","Augmented Inverse","Six Tone Symmetrical"),
		845 => array("Raga Neelangi"),
		851 => array("Raga Hejjajji"),
		857 => array("Equal temperaments 3 and 4 mixed"),
		...
		915 => array("Raga Kalagada (Kalgada)"),
		...
		945 => array("Raga Saravati (Sharavati)"),
		...
		1025 => array("Warao ditonic: South America"),
		1037 => array("Warao tetratonic: South America"),
		1057 => array("Sansagari: Japan"),
		1105 => array("Messiaen truncated mode 6 inverse"),
		1113 => array("Locrian Pentatonic 2"),
		1115 => array("Superlocrian Hexamirror"),
		1123 => array("Iwato: Japan"),
		1129 => array("Raga Jayakauns"),
		1131 => array("Honchoshi plagal form: Japan"),
		1161 => array("Bi Yu: China"),
		...
		1187 => array("Kokin-joshi","Miyakobushi","Han-Iwato","In Sen: Japan","Raga Vibhavari (Revati)","Bairagi, Lasaki"),
		1189 => array("Suspended Pentatonic","Raga Madhyamavati","Madhmat Sarang","Megh","Egyptian","Shang","Rui Bin","Jin Yu","Qing Yu: China","Yo: Japan","Ngu Cung Dao: Vietnam","Yematebela wofe: Ethiopia","Egyptian"),
		1193 => array("Minor Pentatonic", "Pentatonic Minor", "Blues Pentatonic","Raga Dhani (Suddha Dhanyasi)","Abheri","Udhayaravi Chandrika","Qing Shang","Gu Xian","Jia Zhong","Yu: China","P'yongjo-kyemyonjo: Korea","Minyo: Japan","Lai Yai","Lai Noi: Laos","Nam","Northern Sa mac: Vietnam","Peruvian Pentatonic 2","Batti Minor: Ethiopia"),
		1195 => array("Raga Gandharavam","Sabai silt: Ethiopia"),
		1197 => array("Minor Hexatonic","Raga Manirangu","Nayaki","Palasi","Pushpalithika (Puspalatika)","Suha Sughrai","Yo: Japan","Eskimo Hexatonic 1 (Alaska: King Island)"),
		1201 => array("Mixolydian Pentatonic","Nam ai","Oan: Vietnam","Raga Savethri"),
		1205 => array("Raga Siva Kambhoji, Vivardhini, Andhali"),
		1209 => array("Raga Bhanumanjari","Jog"),
		1225 => array("Raga Samudhra Priya","Madhukauns (pentatonic)"),
		1229 => array("Raga Simharava (Sinharavam), Gopikatilaka"),
		...
		1317 => array("Chaio: China"),
		1321 => array("Blues Minor","Raga Malkauns (Malakosh)","Raga Hindola","Man Gong","Quan Ming","Yi Ze","Jiao: China","Shegaye: Ethiopia"),
		1323 => array("Ritsu: Japan","Raga Suddha Todi)"),
		1331 => array("Raga Vasantabhairavi"),
		1353 => array("Raga Harikauns, Chin: China"),
		...
		1387 => array('Locrian', 'Half Diminished Locrian',"Greek Mixolydian","Greek Hyperdorian","Medieval Hypophrygian","Medieval Locrian","Greek Medieval Hyperaeolian","Rut biscale descending","Pien chih: China","Makam Lami","Yishtabach: Jewish"),
		...
		1437 => array("Sabach (Sambah) ascending: Greece"),
		1443 => array("Raga Phenadyuti, Insen, Honchoshi, Niagari: Japan"),
		...
		1451 => array("Phrygian","Greek Dorian","Medieval Phrygian","Greek Medieval Hypoaeolian","Neopolitan Minor","Bhairavi That","Bhairavi Theta","Mela Hanumatodi","Raga Asavari (Asaveri)","Bilashkhani Todi","Ghanta","Makam Kurd","Gregorian nr.3","In","Zokuso: Japan","Ousak: Greece","Major inverse"),
		...
		1459 => array("Phrygian Dominant","Phrygian Major","Spanish Gypsy","Spanish Gipsy","Spanish Romani","Mela Vakulabharanam","Raga Jogiya","Ahiri","Vativasantabhairavi","Zilof","Ahava Rabba","Freygish: Jewish","Maqam Hijaz-Nahawand","Humayun","Dorico Flamenco: Spain","Hitzaz: Greece","Harmonic Major inverse","Altered Hungarian"),
		...
		1483 => array("Mela Bhavapriya","Raga Bhavani","Kalamurti","Neveseri ascending: Greece"),
		...
		1589 => array("Raga Rageshri (Rageshwari), Nattaikurinji (Natakuranji)"),
		...
		1645 => array("Dorian flat 5","Blues Heptatonic","Makam Karcigar","Maqam Nahawand Murassah","Kiourdi ascending","Kartzihiar: Greece"),
		1651 => array("Asian","Oriental","Oriental (b)","Raga Ahira-Lalita","Hungarian Minor inverse","Tsinganikos: Greece"),
		1653 => array("Minor Gipsy inverse"),
		1659 => array("Maqam Shadd'araban"),
		1669 => array("Raga Matha Kokila (Matkokil)"),
		1675 => array("Raga Salagavarali"),
		1677 => array("Raga Manavi"),
		1681 => array("Raga Valaji"),
		1683 => array("Raga Malayamarutam"),
		1697 => array("Raga Kuntvarali (Kuntalavarali)"),
		1699 => array("Raga Rasavali"),
		1701 => array("Dominant Seventh","Mixolydian Hexatonic","P'yongjo: Korea","Yosen: Japan","Raga Darbar","Narayani","Suposhini","Andolika","Gorakh Kalyan"),
		...
		1709 => array("Dorian","Greek Phrygian","Medieval Dorian","Medieval Hypomixolydian","Kafi That","Kafi Theta","Mela Kharaharapriya","Raga Bageshri","Bhimpalasi","Nayaki Kanada","Sriraga","Ritigaula","Huseni","Kanara","Mischung 5","Gregorian nr.8","Eskimo Heptatonic","Yu: China","Hyojo","Oshikicho","Banshikicho: Japan","Nam: Vietnam"),
		1711 => array("Adonai Malakh: Jewish", "Jewish"),
		...
		1717 => array("Mixolydian","Greek Hypophrygian","Greek Ionian (Iastian)","Medieval Mixolydian","Greek Medieval Hypoionian","Hypermixolydian","Khamaj That","Khamaj Theta","Mela Harikambhoji","Raga Harini","Janjhuti","Khambhavati","Surati","Balahamsa","Devamanohari","Mischung 3","Gregorian nr.7","Enharmonic Byzantine Liturgical","Rast descending: Greece","Ching","Shang: China"),
		...
		1737 => array("Raga Madhukauns (hexatonic)"),
		1739 => array("Mela Sadvidhamargini","Raga Sthavarajam","Tivravahini"),
		1741 => array("Altered Dorian","Mela Hemavati","Raga Desisimharavam","Maqam Nakriz","Tunisian","Ukranian Dorian","Romanian Scale","Rumanian Minor","Dorian sharp 4","Misheberekh: Jewish","Souzinak (Peiraiotikos) Minor","Nigriz","Pimenikos: Greece","Ukrainian Minor","Kaffa","Gnossiennes"),
		...
		1783 => array("Youlan scale: China"),
		1789 => array("Blues Enneatonic II"),
		1849 => array("Chromatic Hypodorian inverse"),
		1885 => array("Equal temperaments 4 and 6 mixed"),
		...
		1967 => array("Chromatic and Diatonic Dorian mixed"),
		1981 => array("Houseini: Greece, Modes of Major Pentatonic mixed"),
		1997 => array("Raga Cintamani"),
		2015 => array("Messiaen mode 7"),
		2029 => array("Kiourdi: Greece"),
		2043 => array("Maqam Tarzanuyn"),
		2099 => array("Raga Megharanji"),
		2117 => array("Raga Sumukam"),
		2129 => array("Raga Nigamagamini"),
		2133 => array("Raga Kumurdaki (Kumudki)"),
		2145 => array("Messiaen truncated mode 5 inverse"),
		2197 => array("Raga Hamsadhvani (Hansdhwani, Haunsadhwani)"),
		2211 => array("Raga Gauri"),
		2213 => array("Raga Desh","Tcherepnin Major Pentatonic","Nam xuan: Vietnam"),
		2217 => array("Raga Nata","Udayaravicandrika","Madhuranjani"),
		2221 => array("Raga Sindhura Kafi"),
		2225 => array("Ionian Pentatonic, Raga Gambhiranata, Pelog Degung Modern, Ryukyu: Japan, Vong co: Vietnam, Batti Major: Ethiopia"),
		...
		2257 => array("Lydian Pentatonic","Raga Amritavarshini","Malashri","Shilangi","Batti Lydian: Ethiopia",'Hirajoshi',"Chinese","Augmented"),
		...
		2353 => array("Raga Girija, Bacovia: Romania, Batti Major sharp 5: Ethiopia"),
		...
		2389 => array("Eskimo Hexatonic 2 (Alaska: Point Hope))"),
		...
		2465 => array("Raga Devaranjani (Devaranji)"),
		...
		2477 => array("Harmonic Minor","Mischung 4","Pilu That","Mela Kiravani","Raga Kiranavali","Kirvani","Kalyana Vasantha","Deshi(3)","Maqam Bayat-e-Esfahan","Sultani Yakah","Zhalibny Minor","Armoniko minore: Greece","Mohammedan"),
		2479 => array("Harmonic and Neapolitan Minor mixed"),
		2481 => array("Raga Paraju (Paraz, Pharas), Ramamanohari, Sindhu Ramakriya, Kamalamanohari"),
		2483 => array("Double Harmonic","Major Gipsy","Major Gypsy","Hungarian Gypsy Persian","Double Harmonic Major","Enigmatic","Byzantine","Flamenco Mode","Bhairav That","Bhairav Theta","Mela Mayamalavagaula","Raga Paraj","Kalingada","Gaulipantu","Lalitapancamam","Chromatic 2nd Byzantine Liturgical","Hitzazkiar: Greece","Maqam Zengule","Hijaz Kar","Suzidil"),
		2485 => array("Harmonic Major","Mela Sarasangi","Raga Haripriya","Simhavahini","Mischung 2","Ethiopian","Tabahaniotikos: Greece"),
		2489 => array("Mela Gangeyabhusani","Raga Gangatarangini","Sengiach (Sengah): Greece","Gipsy Hexatonic inverse"),
		...
		2509 => array("Double Harmonic Minor","Hungarian Minor","Egyptian Heptatonic","Mela Simhendramadhyama","Raga Madhava Manohari","Maqam Nawa Athar","Hisar","Flamenco Mode","Niavent: Greece"),
		2515 => array("Chromatic Hypolydian","Purvi That","Purvi Theta","Mela Kamavardhani","Raga Shri","Pantuvarali","Basant","Kasiramakriya","Suddharamakriya","Puriya Dhanashri","Dhipaka","Pireotikos: Greece"),
		...
		2547 => array("Raga Ramkali (Ramakri)"),
		2581 => array("Raga Neroshta"),
		2597 => array("Raga Rasranjani"),
		2601 => array("Raga Chandrakauns (modern)","Marga Hindola","Rajeshwari"),
		...
		2741 => array("Major","Ionian","Greek Lydian","Medieval Ionian","Medieval Hypolydian","Major","Bilaval That","Bilaval Theta","Mela Shankarabharanam","Mela Dhirasankarabharana","Raga Atana","Ghana Heptatonic","Peruvian Major","Matzore","Rast ascending: Greece","4th plagal Byzantine","Ararai: Ethiopia","Makam Cargah","Ajam Ashiran","Dastgah-e Mahur","Dastgah-e Rast Panjgah","Xin: China, DS2"),
		2745 => array("Mela Sulini","Raga Sailadesakshi","Raga Trishuli","Houzam: Greece"),
		...
		2771 => array("Marva That","Marva Theta","Mela Gamanasrama","Raga Partiravam","Puriya","Puriya Kalyan","Purvikalyani","Sohani","Bairari","Harsh-intense Major","Peiraiotikos: Greece"),
		2773 => array("Lydian","Greek Hypolydian","Medieval Lydian","Greek Medieval Hypolocrian","Rut biscale ascending","Kalyan That (Yaman)","Kalyan Theta","Mela Mecakalyani","Raga Shuddh Kalyan","Ping","Kung","Gu: China"),
		...
		2805 => array("Ishikotsucho: Japan","Raga Yaman Kalyan","Chayanat","Bihag","Hamir Kalyani","Kedar","Gaud Sarang","Genus diatonicum veterum correctum","Gregorian nr.5","Kubilai's Mongol scale","Major/Lydian mixed"),
		...
		2907 => array("Magen Abot: Jewish"),
		2917 => array("Nohkan Flute scale: Japan"),
		...
		2989 => array("Zirafkend: Arabic","Melodic Minor Bebop","Minor Bebop","Bebop Minor"),
		...
		3419 => array("Magan Abot",'Jewish (Magan Abot)'),
		...
		3485 => array("Sabach (Sambah): Greece"),
		3499 => array("Hamel"),
		3501 => array("Maqam Nahawand","Farahfaza","Raga Suha (Suha Kanada)","Gregorian nr.4","Utility Minor"),
		3507 => array("Maqam Hijaz (Hedjaz)"),
		3515 => array("Moorish Phrygian","Phrygian/Double Harmonic Major mixed"),
		3519 => array("Raga Sindhi-Bhairavi"),
		3531 => array("Neveseri: Greece"),
		...
		3765 => array("Dominant Bebop","Genus diatonicum","Bebop Dominant","Raga Khamaj","Desh Malhar","Alhaiya Bilaval","Devagandhari","Bihagara","Maqam Shawq Awir","Gregorian nr.6","Major/Mixolydian mixed","Chinese Eight-Tone","Rast: Greece"),
		3767 => array("Chromatic Bebop"),
		3773 => array("Raga Malgunji","Ramdasi Malhar","Major/Dorian mixed","Blues Enneatonic"),
		3829 => array("Taishikicho","Ryo: Japan","Raga Chayanat","Lydian/Mixolydian mixed"),
